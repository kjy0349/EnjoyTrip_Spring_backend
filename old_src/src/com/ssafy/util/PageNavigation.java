...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		if(currentPage == 1) {
			builder.append("				<a href=\"#\" class=\"page-link bg-body-tertiary text-secondary\" style=\"pointer-events: none;\">처음</a> \n");						
			builder.append("			</li> \n");
			builder.append("			<li class=\"page-item\" data-pg=\"" + (this.startRange ? 1 : (startPage - 1)) + "\"> \n");
			builder.append("				<a href=\"#\" class=\"page-link bg-body-tertiary text-secondary\" style=\"pointer-events: none;\">이전</a> \n");
			builder.append("			</li> \n");
		} else {
		...
		if(currentPage == totalPageCount) {
			builder.append("				<a href=\"#\" class=\"page-link bg-body-tertiary text-secondary\" style=\"pointer-events: none\">다음</a> \n");
			builder.append("			</li> \n");
			builder.append("			<li class=\"page-item\" data-pg=\"" + totalPageCount + "\"> \n");
			builder.append("				<a href=\"#\" class=\"page-link bg-body-tertiary text-secondary\" style=\"pointer-events: none;\">마지막</a> \n");			
		} else {			
